...
class AutoPanopticBody(nn.Module):
    def __init__(self, model_size='3.8G'):
        ...
        elif '3.8G' in model_size:
            stage_repeats = [8, 8, 16, 8]
            stage_out_channels = [-1, 72, 172, 432, 864, 1728, 1728]
        else:
            raise NotImplementedError

        architecture = [3,2,0,2,1,3,2,0,1,3,1,3,3,0,0,1,0,0,1,0,2,3,2,2,1,0,1,3,1,2,2,1,1,2,0,2,0,2,3,0]
        print('COCO 3.8G:', architecture)
        # architecture = [1,2,3,1,1,2,1,2,0,3,2,2,1,3,1,3,1,3,3,2,1,0,0,2,1,3,2,0,1,1,0,3,0,3,0,3,3,1,3,3]
        # print('ADE_3.8G:', architecture)
