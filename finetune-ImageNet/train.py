...
import logging
import argparse
from autopanopticbody import AutoPanopticBody
...
def get_args():
    parser = argparse.ArgumentParser("Autopanopticbody")
    parser.add_argument('--eval', default=False, action='store_true')
    parser.add_argument('--eval-resume', type=str, default='./supernet.pkl', help='path for eval model')
    ...
    parser.add_argument('--save', type=str, default='./supernet_models', help='path for saving trained models')
    ...
    parser.add_argument('--save-interval', type=int, default=5000, help='report frequency')

    parser.add_argument('--train-dir', type=str, default='supernet_data/train', help='path to training dataset')
    parser.add_argument('--val-dir', type=str, default='supernet_data/val', help='path to validation dataset')

    parser.add_argument('--model-size', type=str, default='1.3G', help='300M or 1.3G or 3.8G')
...
def main():
    ...
    print('total_iters:', args.total_iters)
    model = AutoPanopticBody(args.model_size)
    print(model)
