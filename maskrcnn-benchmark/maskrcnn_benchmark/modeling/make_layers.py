...
def group_norm(out_channels, affine=True, divisor=1, groups=None):
...
class GroupNorm(nn.Module):
    def __init__(self, out_channels, affine=True, divisor=1, groups=None):
        super(GroupNorm, self).__init__()
        self.groupnorm = group_norm(out_channels=out_channels, affine=affine, divisor=divisor, groups=groups)
