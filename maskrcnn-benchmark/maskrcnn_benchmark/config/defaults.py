...
_C.MODEL.BACKBONE.CHANNEL_SHUFFLE_METHOD = 1
_C.MODEL.BACKBONE.STAGE_OUT_CHANNELS = [] # [-1, 48, 96, 240, 480, 960]
_C.MODEL.BACKBONE.STAGE_REPEATS = [8, 8, 16, 8] # [4, 4, 8, 4]
...
# ---------------------------------------------------------------------------- #
# SEGMENT BRANCH options
# ---------------------------------------------------------------------------- #
_C.MODEL.SEG_BRANCH = CN()
_C.MODEL.SEG_BRANCH.ADD_SEG_BRANCH = True
_C.MODEL.SEG_BRANCH.SEGMENT_BRANCH = "AutoPanoptic_Segmentation_Branch"
_C.MODEL.SEG_BRANCH.DECODER_CHANNEL = 128
_C.MODEL.SEG_BRANCH.MERGE_OP = "add"
_C.MODEL.SEG_BRANCH.CLS_NUM = 54 # 53 stuff, 1 thing
_C.MODEL.SEG_BRANCH.LAMDA_INSTANCE = 1.0
_C.MODEL.SEG_BRANCH.LAMDA_SEGMENTATION = 0.3
_C.MODEL.SEG_BRANCH.SUBNET_DEPTH = 2
_C.MODEL.SEG_BRANCH.SHARE_SUBNET = True
_C.MODEL.SEG_BRANCH.JSON_PATH = ''

# ---------------------------------------------------------------------------- #
# INTER BRANCH MODULE options
# ---------------------------------------------------------------------------- #
_C.MODEL.INTER_MODULE = CN()
_C.MODEL.INTER_MODULE.TURN_ON = True
_C.MODEL.INTER_MODULE.NAME = "AutoPanoptic_Inter_module_search"
...
# _C.MODEL.RESNETS.STEM_OUT_CHANNELS = 48
...
# Misc options
# ---------------------------------------------------------------------------- #
_C.OUTPUT_DIR = "./cachemodel/tmp/"

_C.PATHS_CATALOG = os.path.join(os.path.dirname(__file__), "paths_catalog.py")

_C.TENSORBOARD_EXPERIMENT = "logs/"
_C.INFO = ""
_C.EXP = ""
# ---------------------------------------------------------------------------- #
# Precision options
...
# NAS
_C.NAS = CN()
_C.NAS.TEST_CYCLE = 20
_C.NAS.TOPK = 3
_C.NAS.TRAIN_SUPERNET = False
_C.NAS.TRAIN_SINGLE_MODEL = False
_C.NAS.SKIP_NAS_TEST = False
_C.NAS.INTER_SIZE = 3
_C.NAS.INTER_LAYERS = 9
